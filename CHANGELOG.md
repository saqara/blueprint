...
- 2026-09-25 — `alert` : emplacement `AlertAction` (3e colonne, en haut à droite) et `AlertClose` (bouton X, « Fermer » par défaut) pour les alertes refermables, en React et en Vue.
