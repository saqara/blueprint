...
export const COMPANIES: Company[] = [
  { siren: "552 100 554", name: "Bâti Sud SAS", city: "Lyon", dept: "69", status: "qualified", score: 16 },
  { siren: "402 812 377", name: "Élec Rhône", city: "Villeurbanne", dept: "69", status: "pending", score: 12 },
  { siren: "318 455 902", name: "Plomberie Dupuis", city: "Vienne", dept: "38", status: "qualified", score: 18 },
  { siren: "791 204 118", name: "Menuiseries Alpines", city: "Grenoble", dept: "38", status: "qualified", score: 15 },
  { siren: "533 870 461", name: "Charpentes du Forez", city: "Saint-Étienne", dept: "42", status: "pending", score: 11 },
  { siren: "480 116 732", name: "Ain Couverture", city: "Bourg-en-Bresse", dept: "01", status: "qualified", score: 14 },
  { siren: "612 309 845", name: "Atelier Métal Lyonnais", city: "Vénissieux", dept: "69", status: "qualified", score: 17 },
  { siren: "845 772 019", name: "Isolation Durable", city: "Échirolles", dept: "38", status: "pending", score: 9 },
  { siren: "377 640 283", name: "Carrelages Marseillais", city: "Marseille", dept: "13", status: "qualified", score: 13 },
  { siren: "905 118 640", name: "Provence Béton", city: "Aix-en-Provence", dept: "13", status: "qualified", score: 16 },
  { siren: "428 903 571", name: "Bordeaux Façades", city: "Bordeaux", dept: "33", status: "pending", score: 10 },
  { siren: "690 244 318", name: "Gironde Étanchéité", city: "Mérignac", dept: "33", status: "qualified", score: 15 },
  { siren: "512 887 004", name: "Nord Terrassement", city: "Lille", dept: "59", status: "qualified", score: 14 },
  { siren: "761 330 925", name: "Flandres Peinture", city: "Roubaix", dept: "59", status: "pending", score: 8 },
  { siren: "338 491 267", name: "Paris Ascenseurs", city: "Paris", dept: "75", status: "qualified", score: 19 },
  { siren: "874 015 336", name: "Seine Ventilation", city: "Paris", dept: "75", status: "pending", score: 12 },
  { siren: "457 662 190", name: "Loire Serrurerie", city: "Roanne", dept: "42", status: "qualified", score: 13 },
  { siren: "593 728 441", name: "Rhône Vitrages", city: "Lyon", dept: "69", status: "qualified", score: 15 },
  { siren: "728 450 663", name: "Dauphiné Plâtrerie", city: "Voiron", dept: "38", status: "pending", score: 11 },
  { siren: "366 095 812", name: "Bresse Électricité", city: "Oyonnax", dept: "01", status: "qualified", score: 16 },
  { siren: "819 337 540", name: "Calanques Aménagement", city: "La Ciotat", dept: "13", status: "pending", score: 7 },
  { siren: "644 581 209", name: "Médoc Charpente", city: "Pauillac", dept: "33", status: "qualified", score: 14 },
  { siren: "497 206 385", name: "Lys Chauffage", city: "Tourcoing", dept: "59", status: "qualified", score: 17 },
...
<template>
  <AppShellSidebar class="h-full min-h-0 [&_.h-svh]:h-full" :nav="nav" active-id="annuaire"
    :user="{ name: 'Camille Martin', email: 'camille.martin@exemple.fr' }" @sign-out="() => {}">
    <div class="space-y-6">
