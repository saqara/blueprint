...
export const CATEGORIES = [
  { id: "formulaires", label: "Formulaires", items: ["button", "checkbox", "field", "file-dropzone", "input", "input-group", "label", "multi-select", "password-input", "radio-group", "select", "slider", "switch", "tag-input", "textarea", "toggle", "toggle-group"] },
